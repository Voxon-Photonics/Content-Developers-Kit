...
@author: Mathew Veccchio for Voxon
"""

# various data types for Voxon Development using Python.
# Note all class names are in lowercase and written in the same style as it's native voxiebox.h to make cut and paste of functions easier. 
#
# Types are based on the Dec 8th 2022 Runtime
