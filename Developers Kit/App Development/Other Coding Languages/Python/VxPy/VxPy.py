# -*- coding: utf-8 -*-
"""
Created on Wed Nov 30 17:56:43 2022

Python wrapper for Voxon Development. Not quite ready for public release....

see VxPy Example folder to learn how to use / to make your own apps. 

VxPy is the samevVallina VX development *see voxiebox.txt for a list of function calls / descriptions
...
Better debuging - close VX App if there is some error
...
Work out a way to do function pointers for playback audio and menu funcions 
...
class VxPy:    
    ...
    def __init__(self):
               ...
               try:
                   ...
                   self.k32 = WinDLL('kernel32') ## load in the Windows Kernel so we can ensure the voxiebox.dll is free
                   self.DLLloaded = True
                   print("                    ____")
                   print("                 .'`_ o `;__,")
                   print("       .       .'.'` '---'  ' ")
                   print("       .`-...-'.'        VxPy - Voxon Python Wrapper  ")
                   print("        `-...-'   for VX Runtime 8th of December 2022")
                   print(" ")    
                   
                   print("VxPy - Voxon Pyhton Wrapper ::")
               ...
               try:
                ...
                # Core
                   ...
                   # initalises the VX instance. params = (pointer to voxie_wind_t)
                   self.vxDLL.voxie_init.argtypes = [POINTER(voxie_wind_t)]
                   # loads in the settings from voxiebox.ini and voxiebox_menu0.ini params = (pointer to voxie_wind_t the VX instance. params = (pointer to voxie_wind_t)      
              ...
              #  voxie_drawspr = (int(__cdecl*)(voxie_frame_t*, const char*, point3d*, point3d*, point3d*, point3d*, int)
                ...
                # Sound   
                  ...
                  # self.vxDLL.voxie_setaudplaycb.argtypes = [POINTER(userplayfunc),POINTER(c_int), c_int] ## how do you pass in user functions?
                  # self.vxDLL.voxie_setaudreccb.argtypes = [POINTER(userrecfunc),POINTER(c_int), c_int]   ## how do you pass in user functions?
                ...
                ### END OF DEFINE ALL THE VOXIE FUNCTIONS ARGTYPES & RETURN TYPES
                   ...
                   print("VxPy - initialized successfully")
               except Exception as e:
                    print("VxPy - initialized unsuccessfully")
                    print(e)
    ...
    def __del__(self):
        ...
        if self.DLLloaded == True: 
            try:
                ...
                print("Error  : couldn't call voxie_uninit_int(0)")
                print(e)
                success = False
        ...
        try:
            ...
            self.k32.FreeLibrary(self.vxDLL._handle) 
             ...
             print("Error  : couldn't call k32 Free Library(0)")
             print(e)               
             success = False
                 
        if success:
            print("VxPy exit successfully\n\nKeep only seeing this screen and not seeing the VoxieBox Window?? Try restarting the Python Kernel!")
        else :
            print("VxPy exit with errors")           
    ...
    def CoreUpdate(self):
        try:
            ...
            print("Error  : Couldn't perform VxPy core update")
            print(e)         
            self.Uninit()
    ...
    def ShowStats(self, posx, posy):
        ...
        try:
            self.vxDLL.voxie_debug_print6x8(posx, posy, 0x00ff00,0x003300, c_char_p(b"VxPy --====e"))
            posy += 8
            ...
            print("Error in VxPy's Showstats function")
            print(e)
