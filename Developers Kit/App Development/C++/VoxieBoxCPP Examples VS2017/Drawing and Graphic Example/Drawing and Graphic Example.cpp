	...
	case TEXURED_MESH:
		...
		if (gInited == 0) {
			...
			case 2:
				...
				i = 0;
				j = 0;
				vertice1[j].x =-0.7; vertice1[j].y =-0.7; vertice1[j].z = 0; vertice1[j].col = 0xff0000;  vertice1[j].u = 0; vertice1[j].v = 0; // LTU
				j++;
				vertice1[j].x =-0.3; vertice1[j].y =-0.7; vertice1[j].z = 0; vertice1[j].col = 0xff0000;  vertice1[j].u = 1; vertice1[j].v = 0; //  RTU
				j++;
				vertice1[j].x =-0.7; vertice1[j].y =-0.3; vertice1[j].z = 0; vertice1[j].col = 0xff0000;  vertice1[j].u = 0; vertice1[j].v = 1; //  LBU
				j++;
				vertice1[j].x =-0.3; vertice1[j].y =-0.3; vertice1[j].z = 0; vertice1[j].col = 0xff0000;  vertice1[j].u = 1; vertice1[j].v = 1; // RBU

				j++;
				vertice1[j].x = 0.7; vertice1[j].y = 0.7; vertice1[j].z = 0; vertice1[j].col = 0x00ff00; vertice1[j].u = 0; vertice1[j].v = 0;  // LTU
				j++;
				vertice1[j].x = 0.3; vertice1[j].y = 0.7; vertice1[j].z = 0; vertice1[j].col = 0x00ff00; vertice1[j].u = 1; vertice1[j].v = 0; // RTU
				j++;
				vertice1[j].x = 0.7; vertice1[j].y = 0.3; vertice1[j].z = 0; vertice1[j].col = 0x00ff00; vertice1[j].u = 0; vertice1[j].v = 1; // LBU
				j++;
				vertice1[j].x = 0.3; vertice1[j].y = 0.3; vertice1[j].z = 0; vertice1[j].col = 0x00ff00; vertice1[j].u = 1; vertice1[j].v = 1;// RBU
			
		
			   // using a QUAD instead of two triangles - Since we support it  s

			   mesh1[i++] = 0; mesh1[i++] = 1; mesh1[i++] = 3; mesh1[i++] = 2;  mesh1[i++] = -1; /*-1 = end of polygonal facet*/

				// making the mesh using two triangles -- shaded in blue
				...
				meshNo = i;
				meshDrawMode = 16 + fillMode;
				//sprintf_s(textureFName, "assets/plane.png"); -- uncomment this to see texture
				sprintf_s(textureFName, "");
