...
public:
	...
	virtual void drawMeshExt(char* fileNam, point3d* VerticeXYZArray, int verticeXYZNum, uvcol_t* verticcUVCArray, int verticeUVCNum,  inds_t* indiceArray, int indiceNum, int flags, int col) = 0;
...
public:
	...
	void drawMeshExt(char* fileNam, point3d* VerticeXYZArray, int verticeXYZNum, uvcol_t* verticcUVCArray, int verticeUVCNum,  inds_t* indiceArray, int indiceNum, int flags, int col);
...
#pragma region DLL_Functions
	...
	void(__cdecl* voxie_drawmeshtex_ext)(voxie_frame_t* vf, char* texnam,  point3d* xyz, int xyzn,  uvcol_t* uvc, int uvcn,  inds_t* inds, int ninds, int flags, int col);
