...
VXSimpleSerial::VXSimpleSerial(char* com_port, DWORD COM_BAUD_RATE)
{
	connected_ = false;
...
VXSimpleSerial::VXSimpleSerial(char* com_port, DWORD COM_BAUD_RATE, int DebugPosX, int DebugPosY)
{
	this->posX = DebugPosX;
	this->posY = DebugPosY;


	VXSimpleSerial(com_port, COM_BAUD_RATE);
}

void VXSimpleSerial::TryNewPort(char * com_port, DWORD COM_BAUD_RATE)
{
	connected_ = false;
...
void VXSimpleSerial::CustomSyntax(string syntax_type) {
...
string VXSimpleSerial::ReadSerialPort(int reply_wait_time, string syntax_type) {
...
bool VXSimpleSerial::WriteSerialPort(char *data_sent)
{
	DWORD bytes_sent;	
...
bool VXSimpleSerial::CloseSerialPort()
{
	if (connected_) {
		connected_ = false;
...
bool VXSimpleSerial::CheckConnection() {
...
bool VXSimpleSerial::CheckhandShake()
{
	return handshakeState;
}

void VXSimpleSerial::setHandShake(bool option)
{
	handshakeState = option;
}

/*
VXSimpleSerial::SendMessage(char* Message) {
